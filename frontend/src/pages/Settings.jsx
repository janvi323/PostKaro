  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-6">
      ...
      <form onSubmit={handleSubmit} className="card p-6 space-y-6">
        ...
        <div className="flex items-center gap-6">
          <div className="relative group">
            <img
              ...
              className="w-24 h-24 rounded-full object-cover border-4 border-softIvory"
              alt="Profile"
            />
            <label
        ...
        {/* Privacy */}
        <div className="flex items-center justify-between p-4 bg-mainBg/50 rounded-xl">
          <div>
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className="w-11 h-6 bg-gray-200 peer-focus:ring-2 peer-focus:ring-brandGreen/50
                            rounded-full peer peer-checked:bg-brandGreen transition
